...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['leg_id'], ['legs.id'],
            name=op.f('fk_events_leg_id_legs'), ondelete='SET NULL',
        ),
        sa.ForeignKeyConstraint(
            ['shipment_id'], ['shipments.id'],
            name=op.f('fk_events_shipment_id_shipments'), ondelete='CASCADE',
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['alert_id'], ['alerts.id'],
            name=op.f('fk_reroute_options_alert_id_alerts'), ondelete='CASCADE',
        ),
    ...
    with op.batch_alter_table('reroute_options', schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f('ix_reroute_options_alert_id'), ['alert_id'], unique=False
        )
