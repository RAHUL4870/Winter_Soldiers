...
def upgrade() -> None:
    ...
    with op.batch_alter_table('legs', schema=None) as batch_op:
        batch_op.create_index('ix_legs_shipment_version_seq', ['shipment_id', 'route_version', 'sequence_number'], unique=False)
    ...
    with op.batch_alter_table('position_reports', schema=None) as batch_op:
        batch_op.create_index('ix_position_reports_asset_time', ['asset_type', 'mmsi', 'reported_at'], unique=False)

    with op.batch_alter_table('events', schema=None) as batch_op:
        batch_op.create_index('ix_events_shipment_id_occurred_at_desc', ['shipment_id', 'occurred_at'], unique=False)
